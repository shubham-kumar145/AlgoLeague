...
// //   return (
// //     <div className="container mx-auto px-4 py-6 min-h-screen bg-[#020617]">
// //         <div className="flex items-center justify-between px-6 py-4 bg-base-100 shadow-md rounded-xl mb-6 w-full flex-wrap gap-y-4">
...
// //                 </div>
// //             </div>
// //       {/* <div className="flex justify-center items-center mb-6 border-b border-gray-300 pb-2">
